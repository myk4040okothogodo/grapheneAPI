    ...
    def resolve_books(self, info, search=None):
        if search:
            filter = (
                    ...
                    Q(author_icontains=search)|
                    Q(description_icontains=search)|
                    Q(publisher_book_url_icontains=search)
                    )
...
class CreateBook(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        if user.is_anonymous:
            raise GraphQlError("user must be logged in to create a book")
...
class UpdateBook(graphene.Mutation):
    ...
    def mutate(self, info, book_id, title=None, author=None, description=None, publisher_book_url=None):
        ...
        if user.is_anonymous:
            raise GraphQlError("User must be logged in to update a book. Also user must be creator")
        ...
        book.publisher_book_url = publish_book_url if publisher_book_url != None and publisher_book_url != " " else book.publisher_book_url
...
class DeleteBook(graphene.Mutation):
    ...
    def mutate(self, info, book_id):
        ...
        if user.is_anonymous:
            raise GraphQLError("user must be logged in to update a book, must also be a creator")
